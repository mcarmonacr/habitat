...
public class AgreementController {
	 ...
	 * 
	 */
	@RequestMapping(value= "/asociarProyectoCorporacion", method = RequestMethod.POST/*, headers = "Accept=application/json", consumes=MediaType.APPLICATION_JSON_VALUE, produces=MediaType.APPLICATION_JSON_VALUE*/)
	public @ResponseBody AjaxResponseBody asociarProyectoCorporacion(@RequestBody Map<String, String> json){
		...
		try{
			...
			if(json.get("projectId") != null && json.get("corporationId") != null){
			
				ajaxResponse.setContent(getProjectAndCorporationInfo(json.get("projectId"), json.get("corporationId")));
	...
	private Map <String, Object> getProjectAndCorporationInfo(String projectId, String corporationId){
		
		Map <String, Object> projectAndCorporationMap = new HashMap <String, Object> ();
		
		//Get the project and corporation
		Corporation corporation= corporationDAO.findById(Integer.getInteger(corporationId));
		Project project= projectDAO.findById(Integer.getInteger(projectId));
		
		//Put the formatted data into data map
		projectAndCorporationMap.put("corporationData", getCorporationData(corporation));
		projectAndCorporationMap.put("projectData", getProjectData(project));
		
		return projectAndCorporationMap;
		
	}
	
	private Map <String, Object> getCorporationData(Corporation corporation){
		
		Map <String, Object> corporationMap = new HashMap <String, Object> ();
		
		corporationMap.put("corporationName", corporation.getCorporationName());
		corporationMap.put("industry", corporation.getIndustry());
		corporationMap.put("scope", corporation.getScope());
		corporationMap.put("actionAxis", corporation.getActionAxis());
		corporationMap.put("address", corporation.getAddress());
		corporationMap.put("habitatParticipation", corporation.getHabitatParticipation());
		corporationMap.put("comments", corporation.getComments());
		corporationMap.put("availableDate", corporation.getAvailableDate());
		
		//Get the contact information
		corporationMap.put("corporationContact", getContactData(corporation.getContacts()));
		
		return corporationMap;
	}
	
	private Map <String, Object> getProjectData(Project project){
		
		Map <String, Object> projectMap = new HashMap <String, Object> ();
		
		projectMap.put("projectName", project.getProjectName());
		projectMap.put("projectCode", project.getProjectCode());
		projectMap.put("projectScope", project.getProjectScope());
		
		//Get the contact information
		projectMap.put("projectContact", getContactData(project.getContacts()));
		
		return projectMap;
	}
	
	private Map <String, Object> getContactData(Set<Contact> contacts){
...
//	        if (contact.equals(new Contact("Hello")))
//	            System.out.println("foo found");
			contactMap.put("contactName", contact.getContactName());
			contactMap.put("officePhoneNumber", contact.getOfficePhoneNumber());
			contactMap.put("corporateEmail", contact.getCorporateEmail());
			contactMap.put("position", contact.getPosition());
			contactMap.put("country", contact.getCountry());
			contactMap.put("city", contact.getCity());
			contactMap.put("state", contact.getState());
			contactMap.put("zipCode", contact.getZipCode());
	 ...
	 * 
	 */
	@RequestMapping(value= "/agregarConvenio", method = RequestMethod.POST/*, headers = "Accept=application/json", consumes=MediaType.APPLICATION_JSON_VALUE, produces=MediaType.APPLICATION_JSON_VALUE*/)
	public @ResponseBody AjaxResponseBody agregarConvenio(@RequestPart(value = "data", required = false) AddTermForm addTermForm, @RequestPart(value = "video") MultipartFile videoFile, 
